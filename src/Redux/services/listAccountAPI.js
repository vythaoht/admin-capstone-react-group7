...
export const getListAccountAPI = async () => {
    const { data } = await axiosClient.get(`/QuanLyNguoiDung/LayDanhSachNguoiDung?MaNhom=${"GP07"}`);
    return data;
};
...
export async function addUserAPI(payload) {
    try {
        const response = await axiosClient.post("/QuanLyNguoiDung/ThemNguoiDung", payload);
        return response;
    } catch (error) {
...
export async function updateUserAPI(accountName) {
    try {
        const response = await axiosClient.put(`/QuanLyNguoiDung/CapNhatThongTinNguoiDung?TaiKhoan=${accountName}`);
        return response;
    } catch (error) {
        throw error.response.data.content;
    }
...
export async function deleteUserAPI(accountName) {
    try {
        const response = await axiosClient.delete(`/QuanLyNguoiDung/XoaNguoiDung?TaiKhoan=${accountName}`);
        return response;
    } catch (error) {
        throw error.response.data.content;
    }
